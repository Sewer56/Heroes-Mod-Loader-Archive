...
namespace HeroesModLoaderConfig
{
    public partial class ControllerScreenTwo : Form
    {
        ...
        private void ControllerScreen_Leave(object sender, EventArgs e)
        {
            ...
            try { Program.ConfigFile.ControllerTwo[0] = Convert.ToByte(Btn_StartPause.OwnerDrawText.Substring(Btn_StartPause.OwnerDrawText.IndexOf(" "))); } catch { }
            try { Program.ConfigFile.ControllerTwo[1] = Convert.ToByte(Btn_Jump.OwnerDrawText.Substring(Btn_Jump.OwnerDrawText.IndexOf(" "))); } catch { }
            try { Program.ConfigFile.ControllerTwo[2] = Convert.ToByte(Btn_Action.OwnerDrawText.Substring(Btn_Action.OwnerDrawText.IndexOf(" "))); } catch { }
            try { Program.ConfigFile.ControllerTwo[3] = Convert.ToByte(Btn_FormationR.OwnerDrawText.Substring(Btn_FormationR.OwnerDrawText.IndexOf(" ")));} catch { }
            try { Program.ConfigFile.ControllerTwo[4] = Convert.ToByte(Btn_FormationL.OwnerDrawText.Substring(Btn_FormationL.OwnerDrawText.IndexOf(" ")));} catch { }
            try { Program.ConfigFile.ControllerTwo[5] = Convert.ToByte(Btn_TeamBlast.OwnerDrawText.Substring(Btn_TeamBlast.OwnerDrawText.IndexOf(" ")));} catch { }
            try { Program.ConfigFile.ControllerTwo[6] = Convert.ToByte(Btn_CameraR.OwnerDrawText.Substring(Btn_CameraR.OwnerDrawText.IndexOf(" ")));} catch { }
            try { Program.ConfigFile.ControllerTwo[7] = Convert.ToByte(Btn_CameraL.OwnerDrawText.Substring(Btn_CameraL.OwnerDrawText.IndexOf(" ")));} catch { }
        }
        ...
        { 
            Btn_StartPause.Text = "Button " + Program.ConfigFile.ControllerTwo[0];
            Btn_Jump.Text = "Button " + Program.ConfigFile.ControllerTwo[1];
            Btn_Action.Text = "Button " + Program.ConfigFile.ControllerTwo[2];
            Btn_FormationR.Text = "Button " + Program.ConfigFile.ControllerTwo[3];
            Btn_FormationL.Text = "Button " + Program.ConfigFile.ControllerTwo[4];
            Btn_TeamBlast.Text = "Button " + Program.ConfigFile.ControllerTwo[5];
            Btn_CameraR.Text = "Button " + Program.ConfigFile.ControllerTwo[6];
            Btn_CameraL.Text = "Button " + Program.ConfigFile.ControllerTwo[7];
        }
    }
}
